...
namespace Challenge03.Migrations
{
    ...
    [Migration("20231012171009_Starting-v2")]
    partial class Startingv2
    {
            ...
            modelBuilder.Entity("Challenge03.Models.Card", b =>
                {
                    ...
                    b.HasIndex("BaralhoId")
                        .IsUnique()
                        .HasFilter("[BaralhoId] IS NOT NULL");

                    b.HasIndex("BaralhoId1");
            ...
            modelBuilder.Entity("Challenge03.Models.Card", b =>
                {
                    b.HasOne("Challenge03.Models.Baralho", "Baralho")
                        .WithOne()
                        .HasForeignKey("Challenge03.Models.Card", "BaralhoId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Challenge03.Models.Baralho", null)
                        .WithMany("Cards")
                        .HasForeignKey("BaralhoId1");
